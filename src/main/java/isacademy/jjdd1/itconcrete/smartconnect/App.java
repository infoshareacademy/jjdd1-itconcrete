...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleBusLineData completeBuslineData = sp.getCompleteBusLinesData(136);
        DeparturesFirstStop departuresFirstStop = completeBuslineData.getDeparturesFirstStopDirection1();
